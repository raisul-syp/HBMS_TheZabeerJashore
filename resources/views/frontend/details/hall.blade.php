...
@section('title', "$hall->meta_title")
@section('meta_decription', "$hall->meta_decription")
@section('meta_keyword', "$hall->meta_keyword")
                        ...
                        <div class="card-body">
                            ...
                            <div class="page-description">
                                ...
                                <div class="long-descrp">
                                    {!! html_entity_decode($hall->long_description) !!}
                                </div>
                            </div>
                        </div>
                    </div>
