...
@section('title', "$wellness->meta_title")
@section('meta_decription', "$wellness->meta_decription")
@section('meta_keyword', "$wellness->meta_keyword")
                        ...
                        <div class="card-body">
                            ...
                            <div class="page-description">
                                <div class="short-descrp">
                                    {{ $wellness->short_description }}
                                </div>
                                <div class="long-descrp">
                                    {!! html_entity_decode($wellness->long_description) !!}
                                </div>
                            </div>
                        </div>
                    </div>
