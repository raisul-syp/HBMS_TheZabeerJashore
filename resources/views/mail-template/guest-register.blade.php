                ...
                >
                  ...
                  >
                    <tr>
                      ...
                      <td style="margin: 0 auto; font-size: 12px; font-weight: 300; padding: 10px; text-align: left;">{{ $guest_name }}</td>
                    </tr>
                    <tr>
                      <th style="font-size: 12px; padding: 10px; font-weight: 400; text-align: left;">Email</th>
                      <td style="margin: 0 auto; font-size: 12px; font-weight: 300; padding: 10px; text-align: left;">{{ $guest_email }}</td>
                    </tr>
                    <tr>
                      <th style="font-size: 12px; padding: 10px; font-weight: 400; text-align: left;">Password</th>
                      <td style="margin: 0 auto; font-size: 12px; font-weight: 300; padding: 10px; text-align: left;">{{ $guest_password }}</td>
                    </tr>
                  </table>
                </td>
              </tr>
